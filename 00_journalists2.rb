...
def my_search_area(handles)
    the_twitter_vip.select  
end
...
print the_twitter_vip.sort do |a, b|
    a[1] <=> b[1]
# end

#Trie la liste de handle par taille des handle + petit au + grand
the_twitter_vip.sort_by {
    |handles|
    handles.length 
}

# position dans l'array de la personne @epenser ?
for '@epenser' in the_twitter_vip
    the_twitter_vip.index_handles "@epenser"

# tri nombre de handle par taille : 1, 2, 3 caractères...
